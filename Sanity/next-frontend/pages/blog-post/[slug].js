...
const Post = ({ blog, blogs }) => {
    ...
    return <><>
        <Head>
            <title>{blog.title} - DailyReading™</title>
            <meta charset="utf-8" />
            <meta http-equiv="X-UA-Compatible" content="IE=edge" />
            <meta name="description" content={blog.metadesc2}/>
            <meta name="keywords" content={blog.keyword}/>
            <meta name="author" content={blog.Name}/>
                    ...
                    <div className="ak a_ dw dx">
                        <div className="sg nd">
                            ...
                            <article>
                                <header className="ru">
                                    <div className="fp vi">
                                        <h1 className="h1 rn dark:text-white" data-aos="fade-up">{blog.title}</h1>
                                    </div>
                                    <div className="pv do du rg">
                                        <div className="ip ol op" data-aos="fade-up" data-aos-delay="400"> <a href="#0"></a>
                                            <div> <span className="lc font-bold dark:text-gray-500">{blog.Name}</span> - <span className="lf">{blog.publishedAt}</span> </div>
                                        </div>
                                        <div className="ip op rv pl" data-aos="fade-up" data-aos-delay="600">
                                            <ul className="ip ou fb fk nl">
                                                <li className="nc"> <a className="id fp ll ah aa oj uh ch lz cr cf" href="#0">{blog.categoryI}</a> </li>
                                                <li className="nc"> <a className="id fp ll ah aa oj uv cd lz cr cf" href="#0">{blog.categoryII}</a> </li>
                                            </ul>
                                        </div>
                                    </div>
                                </header>
                                {/* <figure className="ru vc vh" data-aos="fade-up" data-aos-delay="600"> <Image className="su" src="/" width="1024" height="576" alt="News single"/> </figure> */}
                                <div className="fm li portable" data-aos="fade-up">
                                    <PortableText
                                        value={blog.body}
                                ...
                                <footer class="MMM">
                                    <div className="pv do du fp vi mt-6 font-bold">

                                        <div className="fm li fq">Originally published at <a href={`https://${blog.Owner}`} className="lr" target="_blank">{blog.Owner}</a></div>
                                    </div>
                                </footer>
                            </article>
                        </div>
                        <aside className="rb">
                            <div className="sb nd pk">
                                <h3 className="h3 ad rm te _ ui">More From US</h3>
                                                    ...
                                                    <header>
                                                        <a className="ic re" href="blog-post.html">
                                                            <figure className="tq ig fe o_ oq">
                                                                <Image className="tj tz su ik an p o lz ci cl "
                                                                    style={{ "backgroundImage": `url(${builder.image(item.mainImage).width(400).height(250).url() || '/../images/post-01.png'})` }} src='/' layout='responsive' width={400} height={250} />
                                                            </figure>
                                                        </a>
                                                        <div className="rd">
                                                            <ul className="ip ou fb fk nl">
                                                                <li className="nc"> <Link key={item.categoryI.current} href={"/" + item.categoryI}><a className="id fp ll ah aa oj uh ch lz cr cf" href="#0">{item.categoryI}</a></Link> </li>
                                                                <li className="nc"> <Link key={item.categoryI.current} href={"/" + item.categoryII}><a className="id fp ll ah aa oj uh ch lz cr cf" href="#0">{item.categoryII}</a></Link> </li>
                                                            </ul>
                                                        </div>
...
export const getServerSideProps = async (context) => {
    ...
    const blogs = await client.fetch(query2);
    return {
        props: {
            blog,
            blogs
