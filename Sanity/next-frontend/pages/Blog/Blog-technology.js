...
const Blogtechnology = ({ blogs }) => {
    ...
    return (
        <>
            <Head>
                <title>DailyReading - Improve your knowledge || Dailyreading.ml</title>
                <meta charset="utf-8" />
                    ...
                    <section className="tq">
                        <div className="sm nd au hk">
                            <div className="ak a_ dw dx">
                                ...
                                <div className="sb nd pk">

                                    <h4 className="h4  rm _ ui" data-aos="fade-up">Computing <span className="justify"><a href="/Blog/Blog-technology" data-aos="fade-up">See All</a></span></h4>
                                    <div className="iv om dn dl dc oa">
                                        {blogs.slice(0).map((item) => {
                                            return item.subcategory == "computing" &&
                                                <Link key={item.slug.current} href={"/blog-post/" + item.slug.current}>
                                                    <article className="ip oo ik" data-aos="fade-up">
                                                        <header>
                                                            <a className="ic re" href="blog-post.html">
                                                                <figure className="tq ig fe o_ oq">
                                                                    <Image className="tj tz su ik an p o lz ci cl " style={{ "backgroundImage": `url(${builder.image(item.mainImage).width(400).height(250).url() || '/../images/post-01.png'})` }} src='/' width={400} height={250} />
                                                                </figure>
                                                            </a>
                                                            <div className="rd">
                                                                <ul className="ip ou fb fk nl">
                                                            ...
                                                            <h3 className="h3 text-2xl ra"> <a className="c_ lz cr cf text-hover" href="blog-post.html">{item.title}</a> </h3>
                                                        </header>
                                                        <p className="fm li sz">{item.metadesc}</p>
                                                        <footer className="ip ol rv"> <a href="#0"></a>
                                                            <div className="fk"> <a className="lr c_ lz cr cf text-hover" href="#0">{item.Name}</a> - <span className="lc">  </span> <span className="lf">{item.publishedAt}</span> </div>
                                                        </footer>
                                                    </article>
                                                </Link>
                                        })}
                                ...
                                <div className="sb nd pk mt-6">
                                    <h4 className="h4  rm _ ui" data-aos="fade-up">Apple <span className="justify"><a href="/Blog/Blog-technology" data-aos="fade-up">See All</a></span></h4>
                                    <div className="iv om dn dl dc oa">
                                        {blogs.slice(0).map((item) => {
                                ...
                                {/* <nav className="ip op fn" role="navigation" aria-label="Pagination Navigation">
                                    <ul className="id ou fk fy nl">
                                        <li className="nc"> <span className="cursor-pointer id i_ sv op ol ud au oj lf cy ce cr cf">Prev</span> </li>
                                        <li className="nc"> <a href="#0" className="id i_ sv op ol ud ap oj ls cy ce cr cf">1</a> </li>
                                        <li className="nc"> <a href="#0" className="id i_ sv op ol ud ap oj ls cy ce cr cf">2</a> </li>
                                        <li className="nc"> <a href="#0" className="id i_ sv op ol ud ap oj ls cy ce cr cf">3</a> </li>
                                        <li className="nc"> <span className="id i_ sv op ol ud ap oj lf">...</span> </li>
                                        <li className="nc"> <a href="#0" className="id i_ sv op ol ud ap oj ls cy ce cr cf">12</a> </li>
                                        <li className="nc"> <a href="#0" className="id i_ sv op ol ud au oj ls cy ce cr cf">Next</a> </li>
                                    </ul>
                                </nav> */}
                            </div>
                        </div>
